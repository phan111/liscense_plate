	...
	<?php
            ...
            if(!empty($_GET)){
                foreach($values AS $key){
                    ...
                    }elseif(strpos($key[7], $_GET['search']) !== FALSE && strpos($key[10], "ไม่") === TRUE){
						echo "<center style='padding-top:10px;font-size:25px'><b>".$key[2]."<br>(".$key[7].") <a href='tel:".$key[5]."'><i class='fa fa-phone fa-2x' style='color:purple;padding-left15px'></i></a><hr style='margin-top:10px'></b></center>";
					}
                }
            }
            ?>
